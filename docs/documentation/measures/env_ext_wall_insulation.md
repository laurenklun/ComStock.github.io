...
| Insulation Type            | R-Value per Inch (hr-ft<sup>2</sup>-°F / Btu) |
|----------------------------|------------------------------------|
...
![](media/51ecb90e3fcba0e4c9a029c1b3b6d636.png)
...
{:refdef: style="text-align: center;"}
![](media/584775fca29b342835aabaaa32185720.png)
...
{:refdef: style="text-align: center;"}
![](media/580334c6728b26c3e362c69ae0e71d4e.png)
...
{:refdef: style="text-align: center;"}
![](media/c8b24a0e6c6132c664afaea3b83a3d0d.png)
{:refdef}
...
|-------------------------------|----------------------------------------------------------------|
| Target R-value                | Target insulation R-value based on climate zone (ft<sup>2</sup>-hr-R/Btu) |
| Insulation R-value per Inch   | XPS R-value per inch (ft<sup>2</sup>-hr-R/Btu per inch)                   |
...
{:refdef: style="text-align: center;"}
![](media/59161f171e763f8f03de85b5eef7b598.jpeg)
{:refdef}
...
{:refdef: style="text-align: center;"}
![](media/8aa503202c09e281d6b69046540a3a3c.jpeg)
{:refdef}
...
{:refdef: style="text-align: center;"}
![](media/3d6ff0c23c5a5f97c367873b38ae31e9.png)
{:refdef}
...
{:refdef: style="text-align: center;"}
![](media/4835d608706ffb3a29d0aa9848a68956.png)
{:refdef}
...
{:refdef: style="text-align: center;"}
![](media/86ea35d13f125ff17361f1263c47d98a.png)
{:refdef}
...
{:refdef: style="text-align: center;"}
![](media/f22cfe91b66cecd22bf1f95bba6f666f.png)
{:refdef}
